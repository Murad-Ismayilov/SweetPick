        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="card text-bg-dark ">
                        <img src="https://res.cloudinary.com/djmsfwo8n/image/upload/v1717760200/collection1_otfm6p.webp" id="img" alt="..."/>
                        <div class="coll-text">
                ...
                <div class="card text-bg-dark ">
                        <img src="https://res.cloudinary.com/djmsfwo8n/image/upload/v1717760200/collection2_jlcqul.webp" id="img" alt="..."/>
                        <div class="coll-text">
                ...
                <div class="card text-bg-dark ">
                        <img src="https://res.cloudinary.com/djmsfwo8n/image/upload/v1717760200/collection3_dkvra2.webp" id="img" alt="..."/>
                        <div class="coll-text">
